...
describe("Config Validation", () => {
  ...
  function setAllRequiredVars() {
    process.env.VITE_CLERK_PUBLISHABLE_KEY = "test_val_0";
    process.env.VITE_CONVEX_URL = "test_val_1";
    process.env.VITE_LIVEBLOCKS_PUBLIC_KEY = "test_val_2";
    process.env.VITE_STRIPE_PUBLISHABLE_KEY = "test_val_3";
  }
