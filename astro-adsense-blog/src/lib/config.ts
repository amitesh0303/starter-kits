/**
 * Typed configuration loader for client-safe environment variables.
 * When absent or placeholder, falls back to disabled mode.
 */
...
/**
 * Reads PUBLIC_ADSENSE_CLIENT_ID and PUBLIC_ANALYTICS_ID from import.meta.env.
 * When absent or placeholder, falls back to disabled mode.
 */
