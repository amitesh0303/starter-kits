export interface AppConfig { supabaseUrl: string | null; supabaseAnonKey: string | null; stripeKey: string | null; isFakeMode: boolean; }
...
export function validateConfig(): ConfigValidationResult {
  ...
  return { valid: true, errors: [], warnings: w, config: { supabaseUrl, supabaseAnonKey, stripeKey, isFakeMode } };
}
