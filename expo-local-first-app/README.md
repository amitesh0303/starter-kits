# Expo Local First App

A production-ready Expo starter for building local-first apps (notes, inventory, field work) with SQLite as primary storage, Supabase for sync, and background task support.
