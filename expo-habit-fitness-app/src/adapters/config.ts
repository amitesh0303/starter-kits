export interface AppConfig { firebaseApiKey: string | null; firebaseProjectId: string | null; revenueCatApiKey: string | null; isFakeMode: boolean; }
...
export function validateConfig(): ConfigValidationResult {
  ...
  return { valid: true, errors: [], warnings: w, config: { firebaseApiKey, firebaseProjectId, revenueCatApiKey, isFakeMode } };
}
